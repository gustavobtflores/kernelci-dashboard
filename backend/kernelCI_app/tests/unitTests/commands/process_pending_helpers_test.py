...
class TestAggregateTestsRollup(SimpleTestCase):
    ...
    def test_compatible_used_as_hardware_key(self):
        ...
        hardware_key_idx = 9
        self.assertEqual(rollup_key[hardware_key_idx], "board-model-a")
    ...
    def test_platform_used_as_hardware_key_when_no_compatible(self):
        ...
        rollup_key = next(iter(result.keys()))
        hardware_key_idx = 9
        self.assertEqual(rollup_key[hardware_key_idx], "qemu-x86")
    ...
    def test_unknown_string_used_as_hardware_key_when_no_compatible_and_no_platform(
        ...
        rollup_key = next(iter(result.keys()))
        hardware_key_idx = 9
        self.assertEqual(rollup_key[hardware_key_idx], UNKNOWN_STRING)
    ...
    def test_empty_compatible_list_falls_back_to_platform(self):
        ...
        rollup_key = next(iter(result.keys()))
        hardware_key_idx = 9
        self.assertEqual(rollup_key[hardware_key_idx], "fallback-platform")
    ...
    def test_issue_info_is_set_from_issues_map(self):
        ...
        rollup_key = next(iter(result.keys()))
        issue_id_idx = 13
        issue_version_idx = 14
        self.assertEqual(rollup_key[issue_id_idx], "issue-42")
        self.assertEqual(rollup_key[issue_version_idx], 3)
    ...
    def test_fail_without_issue_sets_uncategorized_true(self):
        ...
        rollup_key = next(iter(result.keys()))
        issue_uncategorized_idx = 15
        self.assertTrue(rollup_key[issue_uncategorized_idx])
    ...
    def test_fail_with_issue_sets_uncategorized_false(self):
        ...
        rollup_key = next(iter(result.keys()))
        issue_uncategorized_idx = 15
        self.assertFalse(rollup_key[issue_uncategorized_idx])
    ...
    def test_build_none_fields_fall_back_to_unknown_string(self):
        ...
        compiler_idx = 8
        config_idx = 6
        self.assertEqual(rollup_key[arch_idx], UNKNOWN_STRING)
        self.assertEqual(rollup_key[compiler_idx], UNKNOWN_STRING)
        self.assertEqual(rollup_key[config_idx], UNKNOWN_STRING)
    ...
    def test_none_path_uses_empty_path_group(self):
        ...
        rollup_key = next(iter(result.keys()))
        path_group_idx = 5
        self.assertEqual(rollup_key[path_group_idx], EMPTY_PATH_GROUP)
    ...
    def test_path_is_grouped_by_first_segment(self):
        ...
        rollup_key = next(iter(result.keys()))
        path_group_idx = 5
        self.assertEqual(rollup_key[path_group_idx], "kselftest")
